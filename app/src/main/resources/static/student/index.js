...
function getStudent(e) {
  ...
  fetch("../students/" + no)
    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector("#f-photo-origin").href = `https://kr.object.ncloudstorage.com/ncp08-bucket-980406-member-photo/${student.photo}`;
        document.querySelector("#f-photo").src = `https://77auvgwd3604.edge.naverncp.com/d7u1vtMT4l/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } /*else {
